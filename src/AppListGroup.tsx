...
import plane from "./components/pics/frutaer/plane_3-removebg-preview.png";
  ...
  return (
    <div className="Parent-container">
      ...
      <div className="Column-container">
        ...
        <Scroll class="Box-container my-font">
          <div>
            A shy kid, but also very curious about the world around him. Trying
            to grasp as much of it as he possibly can.
          </div>
          <div>
            {img_suikerspin}
            {img_osv}
        ...
        <Scroll class="Box-container my-font">
          <div>
            Getting older, slowly building his own identity. Evaluating what he
            likes and what he doesn't. What he wants to build his own life
            around.
          </div>
          <div>
            {img_ah}
